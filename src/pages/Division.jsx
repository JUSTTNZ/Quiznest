...
import { Divisionarray } from '../components/Divisionarray.jsx'
const Division = () => {
    ...
    const questions = Object.values(Divisionarray)
    ...
    const NextQuestion = () => {
        if(setSelectedanswer !== null && setCurrentQuestion.length-1) {
